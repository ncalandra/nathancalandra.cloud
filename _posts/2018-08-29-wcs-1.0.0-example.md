...
Note that this article is just an exported markdown file based on the original Jupyter notebook which is available [here](https://gitlab.com/ethanfahy/wcs-1.0.0-example-notebook).
### WCS Data Service
